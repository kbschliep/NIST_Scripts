...
pages_to_keep = [0]#[1,3,5,7,9] # page numbering starts from 0
infile = PdfFileReader('Cerutti - Words of the Day Combined.pdf', 'rb')
...
with open('Cerutti - Words of the Day Combined_All.pdf', 'wb') as f:
    output.write(f)